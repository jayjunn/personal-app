        ...
        <div className={styles.about__container}>
          <div className={styles.about__title}>
            <div className={styles.about__arrow}>
              <Image className={(styles.about__arrow, styles.test)} src={anglesRight} alt="icon" width="40" height="40" />
            </div>
      ...
      <div className={styles.right__row}>
        ...
        <div className={styles.arrow__container}>
          <button className={styles.down__arrow} onClick={handleScrollDown}>
            <Image className={styles.down__arrow} src={anglesRight} alt="home" width="40" height="40" />
          </button>
        </div>
      </div>
    </section>
