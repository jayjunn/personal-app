const data = [
  {
    ...
    description: `Token-issuing SaaS for a wide range of companies preparing for an open securities token (STO) market`,
...

  {
    ...
    description: `A global fashion ecommerce project.`,
  ...
  },
  {
    ...
    description: `A platform that allows you to conveniently issue NFTs without installing a separate wallet`,
  ...
  },
  {
    ...
    description: `Humble Bank is an iOS app aimed at helping us track and categorize your transactions.`,
...

  {
    ...
    description: `Glue is a knowledge marketplace where you can find interesting and smart people with a skill to offer.`,
